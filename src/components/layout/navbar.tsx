            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex items-center justify-between h-24">
                    ...
                    <div className="flex items-center gap-4">
                        <Button
                            className="hidden md:inline-flex bg-primary hover:bg-primary/90 text-black font-bold h-11 px-6 text-base shadow-[0_0_20px_rgba(0,229,255,0.3)]"
                        >
                            Get Started
                        </Button>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-24 left-0 right-0 bg-black/95 border-b border-white/10 backdrop-blur-xl md:hidden max-h-[calc(100vh-6rem)] overflow-y-auto"
                    >
                        <div className="flex flex-col p-6 gap-2">
                            ...
                            {simpleLinks.map((link, i) => (
                                <motion.div
                                    ...
                                    initial={{ opacity: 0, x: -20 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={{ delay: (Object.keys(dropdownMenus).length + i) * 0.05 }}
                                >
                                    <Link
                                        href={link.href}
                                        className={cn(
